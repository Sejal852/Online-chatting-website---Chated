	...
	<div class="col-xs-12">
		<form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST" class="signup form-group">
			...
			<div class="form-control">
				...
				<input type="email" class="input-chated" name="email" placeholder="Email" />
			</div>
			<div class="form-control">
				<input type="password" class="input-chated" name="password" placeholder="Password" />
			</div>
			<button type="submit" name="signin" class="btn btn-chated btn-primary">Sign In</button>
		</form>
